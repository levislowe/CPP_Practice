...
*/
    ...
    cout << "x = " << x << endl;
    cout << "y = " << y << endl;
    cout << "The max of x and y is " << max(x, y) << endl; //max() returns the highest value of the variables inside
    cout << "The min of x and y is " << min(x, y) << endl; //min() returns the lowest value of the variables inside
    //functions below come from the library cmath
    x = 64;
    cout << "x = " << x << endl;
    cout << "The square root of x is " << sqrt(x) << endl; //sqrt() returns the square root of x
    x = 2.6;
    cout << "x = " << x << endl;
    cout << "x rounded is " << round(x) << endl; //round() returns the rounded integer of x
    x = 2;
    cout << "x = " << x << endl;
    cout << "The log of x is " << log(x) << endl; //log() returns the log of x
    x = -5;
    cout << "x = " << x << endl;
    cout << "The absolute value of x is " << abs(x) << endl; //abs() returns the absolute value of x
    x = 3.14/6;
    cout << "x = " << x << endl;
    cout << "The arccosine of x is " << acos(x) << endl; //acos() returns the arccosine of x
    cout << "The arcsine of x is " << asin(x) << endl; //asin() returns the arcsine of x
    cout << "The arctangent of x is" << atan(x) << endl; //atan() returns the arctangent of x
    x = 6;
    cout << "x = " << x << endl;
    cout << "The cube root of x is " << cbrt(x) << endl; //cbrt() returns the cube root of x
    x = 5.5;
    cout << "x = " << x << endl;
    cout << "x rounded up is " << ceil(x) << endl; //ceil() returns the value of x rounded up
    cout << "The consine of x is " << cos(x) << endl; //cos() returns the cosine of x
    cout << "The hyperbolic consine of x is " << cosh(x) << endl; //cosh() returns the hyperbolic cosine of x
    cout << "The value of e^x is " << exp(x) << endl; //exp() returns the value of e to the x
    cout << "The value of e^x-1 is " << expm1(x) << endl; //expm1() returns the value of E to the x -1
    cout << "The absolute value of x is " << fabs(x) << endl; //fabs() returns the absolute value of a floating x variable
    cout << "The positive difference of x and y is " << fdim(x, y) << endl; //fdim() returns the positive difference between x and y
    cout << "x rounded down is " << floor(x) << endl; //floor() returns the value of x rounded down
    cout << "The square root of x squared + y squared is " << hypot(x, y) << endl; //returns the square root of x squared + y squared without intermediate overflow or underflow
    cout << "z = " << z << endl;
    cout << "x * y + z is " << fma(x, y, z) << endl; //returns x * y + z without losing precision
    cout << "The highest value of x and y is " << fmax(x, y) << endl; //returns the highest value of a floating x and y
    cout << "The lowest value of x and y is " << fmin(x, y) << endl; //returns the lowest value of a floating x and y
    cout << "The remained of x / y is " << fmod(x, y) << endl; //returns the floating point remainder of x / y
    cout << "x^y is " << pow(x, y) << endl; //returns the value of x to the power of y
    cout << "The sine of x is " << sin(x) << endl; //returns the sine of x
    cout << "The hyperbolic sine of x is " << sinh(x) << endl; //returns the hyperbolic sine of x
    cout << "The tangent of x is " << tan(x) << endl; //returns the tangent of x
    cout << "The hyperbolic tangent of x is " << tanh(x) << endl; //returns the hyperbolic tangent of x
